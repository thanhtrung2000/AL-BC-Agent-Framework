...
- Documents set CurrReport.Language per record. Periods from Accounting Period.
- Object skills never fabricate .rdlc/.docx. The al-report-rdlc-layout skill generates RDLC from a picture/Excel via a validated template + offline checks, and returns PREVIEW_REQUIRED (never "final").
