...
- FlowField over stored where derivable. Match base widths (Code[20], Text[100]). DropDown + Brick field groups on lookups.
- Extensions: field IDs from your OWN range; affix every field; never modify base field properties; behaviour belongs in a subscriber.
