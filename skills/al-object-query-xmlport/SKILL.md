...
Start from [QueryXmlPort.al.template](./templates/QueryXmlPort.al.template). Query DataAccessIntent=ReadOnly. Every non-aggregated column joins the implicit GROUP BY. XMLport: FieldSeparator explicit; validate before insert; culture-invariant parsing.
