...
Never duplicate a base report. Add columns/layouts/request fields; cannot change a column source, remove a base column, or alter the tree (needs a new report). Anchor to top-level DataItems; name it. Affix everything.
| Symptom | Cause |
|---|---|
