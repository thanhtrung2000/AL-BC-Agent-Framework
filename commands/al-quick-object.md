...
description: Create a single new AL object. Skips planning.
agent: al-implementer
---
Create a new AL object.
**Object type:** ${input:type:Table | Page | Codeunit | Enum | Interface | Query | XMLport}
**Purpose:** ${input:purpose:What this object is for}
Check the code first (does it exist?); one file = one object; build to zero errors.
